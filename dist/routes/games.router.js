...
//Schema Joi
const game_schemajoi_1 = __importDefault(require("../schemas-joi/game.schemajoi"));
exports.gamesRouter = express_1.default.Router();
//Middlewares
exports.gamesRouter.use(express_1.default.json());
exports.gamesRouter.get("/", manage_token_1.decodeToken, (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.gamesRouter.post("/", validator_1.default.body(game_schemajoi_1.default), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
